...
'''
trfile = open('C:/Users/nenu410/Desktop/2015-2019-work-descriptors-results-revise.csv', 'r') 
...
for line in trfile:
    ...
    smiles = str(line[10])   #d的smiles
    #smiles = str(line[41])   #a的smiles
